...
class robot:
    ...
    def sense(self):
        ...
        for i in range(len(self.landmarks)):
            landXCor, landYCor = self.landmarks[i][0], self.landmarks[i][1]
            xDiff = landXCor - self.x + (self.rand() * self.measurement_noise)
            yDiff = landYCor - self.y + (self.rand() * self.measurement_noise)
            if xDiff < self.measurement_range and yDiff < self.measurement_range:
                measurements.append((i, xDiff, yDiff))
